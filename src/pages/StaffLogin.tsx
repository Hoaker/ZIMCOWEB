        ...
        {showTimeoutAlert && (
          ...
          >
            ...
            <div>
              ...
              <span className="text-rose-800/80 mt-0.5 block">You were logged out due to inactivity. Please sign in again.</span>
            </div>
          </div>
        )}
          ...
          <div className="bg-white rounded-3xl shadow-xl overflow-hidden border border-slate-200">
            ...
            <div className="bg-slate-900 p-6 sm:p-7 text-white relative">
              <div className="flex items-center gap-2 mb-1">
                <span className="px-2.5 py-0.5 rounded-full bg-slate-800 text-slate-300 text-[10px] font-extrabold uppercase tracking-widest border border-slate-700">
              ...
              <p className="text-xs text-slate-300 mt-1">
                Authorized officers & management control
              </p>
              <div className="w-10 h-10 rounded-2xl bg-slate-800 border border-slate-700 flex items-center justify-center absolute top-6 right-6 text-emerald-400">
                <ShieldCheck className="w-5 h-5" />
              </div>
            </div>

            <div className="p-6 sm:p-8 bg-white text-slate-800">
              ...
              <form onSubmit={handleEmployeeLogin} className="space-y-4">
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input 
                      ...
                      className="w-full pl-10 pr-4 py-3 bg-gray-50 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-slate-800 focus:bg-white text-gray-900 text-sm font-medium transition-colors"
                      required
                      disabled={isLoading}
                    />
                  </div>
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input 
                      ...
                      className="w-full pl-10 pr-10 py-3 bg-gray-50 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-slate-800 focus:bg-white text-gray-900 text-sm font-medium transition-colors"
                      required
                      disabled={isLoading}
                    />
                    <button 
                    ...
                    >
                      {showEmployeePassword ? <EyeOff className="h-5 w-5 text-slate-800" /> : <Eye className="h-5 w-5" />}
                    </button>
                  </div>
                </div>
                ...
                <div className="flex items-center pt-1">
                  ...
                  />
                  <label htmlFor="rememberEmployee" className="ml-2 block text-sm text-gray-600 cursor-pointer select-none">
                ...
                <button 
                  type="submit" 
                  disabled={isLoading}
                  className="w-full mt-2 bg-slate-900 hover:bg-slate-800 text-white font-bold py-3.5 px-4 rounded-xl flex justify-center items-center gap-2 transition-all shadow-lg shadow-slate-900/20 disabled:opacity-70 disabled:cursor-not-allowed cursor-pointer"
                >
                  {isLoading ? (
                    <>
              ...
              <div className="mt-8 text-center border-t border-slate-100 pt-6 space-y-4">
                <p className="text-xs text-slate-500">
                  Restricted to authorized cooperative personnel only.
                </p>
                <div className="flex items-center justify-center text-[10px] text-slate-400 uppercase font-bold tracking-wider">
            ...
            <div className="fixed inset-0 z-[100] flex items-center justify-center bg-slate-900/60 backdrop-blur-sm p-4">
              <div className="bg-white rounded-2xl p-6 max-w-md w-full shadow-2xl border border-slate-100 relative animate-in fade-in zoom-in duration-200">
                ...
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <div>
                    <h3 className="font-headline font-bold text-slate-900 text-lg">Staff Password Recovery</h3>
                    <p className="text-xs text-slate-500">Receive password reset instructions</p>
                  </div>
                </div>
                ...
                <form onSubmit={handleResetPassword} className="space-y-3">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-3.5 py-2.5 bg-slate-50 border border-slate-200 text-slate-900 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-slate-800"
                      required
                  ...
                  <div className="flex gap-2 pt-2">
                    ...
                    <button
                      type="submit"
                      disabled={isResetting}
                      className="flex-1 py-2.5 bg-slate-900 hover:bg-slate-800 text-white font-bold rounded-xl text-xs transition disabled:opacity-50 cursor-pointer"
                    >
